...
const SUITES: Suite[] = [
  {
    ...
    price: "¥3,500 / Night",
    image: "https://kxzimg.pages.dev/v2/OnuasiS.jpeg",
    icon: Trees,
    color: "text-emerald-400",
    features: ["Infinity Pool (室外温水)", "Butler Service (管家服务)", "Helipad (直升机坪)"],
  ...
  {
    id: 2,
    title: "Cliffside Manor (BOUTIQUE)",
    ...
    price: "¥2,400 / Night",
    image: "https://kxzimg.pages.dev/v2/cJDYGPq.png",
    icon: Mountain,
  ...
  {
    id: 3,
    title: "Dune Royal Pavilion (ALPHA)",
    ...
    price: "¥2,500 / Night",
    image: "https://kxzimg.pages.dev/v2/uswcBV5.jpeg",
    icon: Sun,
  ...
  {
    id: 4,
    title: "Lagoon Float (YAUT)",
    subtitle: "Lakeside Haven 山地浅滩)",
    ...
    price: "¥2,600 / Night",
    image: "https://kxzimg.pages.dev/v2/ZOvCZ4U.jpeg",
    icon: Droplets,
    color: "text-cyan-400",
    features: ["Underwater Room (卧室)", "Private Dock (私人入户)", "Aqua Drone (无人机)"],
